          ...
          >
            ...
            <div className="border-t border-gray-200 px-4 py-6">
              <a href="#" className="-m-2 flex items-center p-2">
                ...
                <span className="sr-only">, Sign up seller</span>
              </a>
            </div>
          </DialogPanel>
        </div>
        ...
        >
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              {/* Logo */}
              <div className="ml-4 flex items-center space-x-2 lg:ml-0 cursor-pointer">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a
                    ...
                    className="flex items-center justify-center text-gray-700 hover:text-gray-800 border border-black bg-[#FFF3E3] px-4 py-2 rounded"
                  >
